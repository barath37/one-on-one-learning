	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			function __webpack_require__(moduleId) {
				...
				var module$15 = installedModules[moduleId] = {
					i: moduleId,
					l: false,
					exports: {}
				};
				modules[moduleId].call(module$15.exports, module$15, module$15.exports, __webpack_require__);
				module$15.l = true;
				return module$15.exports;
			}
			...
			__webpack_require__.d = function(exports$13, name, getter) {
				if (!__webpack_require__.o(exports$13, name)) Object.defineProperty(exports$13, name, {
					configurable: false,
					enumerable: true,
					get: getter
				});
			};
			__webpack_require__.n = function(module$16) {
				var getter = module$16 && module$16.__esModule ? function getDefault() {
					return module$16["default"];
			...
			(function(module$17, exports$14, __webpack_require__) {
				"use strict";
				...
				*/
				...
				module$17.exports = LayoutConstants;
			}),
			(function(module$18, exports$15, __webpack_require__) {
				"use strict";
				...
				module$18.exports = LEdge;
			}),
			(function(module$19, exports$16, __webpack_require__) {
				"use strict";
				function LGraphObject(vGraphObject) {
					this.vGraphObject = vGraphObject;
				}
				module$19.exports = LGraphObject;
			}),
			(function(module$20, exports$17, __webpack_require__) {
				"use strict";
				var LGraphObject = __webpack_require__(2);
				...
				*/
				...
				module$20.exports = LNode;
			}),
			(function(module$21, exports$18, __webpack_require__) {
				"use strict";
				function PointD(x, y) {
					if (x == null && y == null) {
						this.x = 0;
				...
				module$21.exports = PointD;
			}),
			(function(module$22, exports$19, __webpack_require__) {
				"use strict";
				var LGraphObject = __webpack_require__(2);
				var Integer = __webpack_require__(10);
				var LayoutConstants = __webpack_require__(0);
				...
				module$22.exports = LGraph;
			}),
			(function(module$23, exports$20, __webpack_require__) {
				"use strict";
				var LGraph;
				var LEdge = __webpack_require__(1);
				...
				module$23.exports = LGraphManager;
			}),
			(function(module$24, exports$21, __webpack_require__) {
				"use strict";
				var LayoutConstants = __webpack_require__(0);
				...
				module$24.exports = FDLayoutConstants;
			}),
			(function(module$25, exports$22, __webpack_require__) {
				"use strict";
				/**
				...
				*/
				...
				module$25.exports = IGeometry;
			}),
			(function(module$26, exports$23, __webpack_require__) {
				"use strict";
				function IMath() {}
				/**
				...
				*/
				...
				module$26.exports = IMath;
			}),
			(function(module$27, exports$24, __webpack_require__) {
				"use strict";
				function Integer() {}
				Integer.MAX_VALUE = 2147483647;
				Integer.MIN_VALUE = -2147483648;
				module$27.exports = Integer;
			}),
			(function(module$28, exports$25, __webpack_require__) {
				"use strict";
			...
			(function(module$29, exports$26, __webpack_require__) {
				"use strict";
				...
				module$29.exports = Point;
			}),
			(function(module$30, exports$27, __webpack_require__) {
				"use strict";
				...
				module$30.exports = RectangleD;
			}),
			(function(module$31, exports$28, __webpack_require__) {
				"use strict";
				...
				module$31.exports = UniqueIDGeneretor;
			}),
			(function(module$32, exports$29, __webpack_require__) {
				"use strict";
				...
				*/
				...
				module$32.exports = Layout;
			}),
			(function(module$33, exports$30, __webpack_require__) {
				"use strict";
				function RandomSeed() {}
				RandomSeed.seed = 1;
				RandomSeed.x = 0;
				...
				module$33.exports = RandomSeed;
			}),
			(function(module$34, exports$31, __webpack_require__) {
				"use strict";
				var PointD = __webpack_require__(4);
				...
				module$34.exports = Transform;
			}),
			(function(module$35, exports$32, __webpack_require__) {
				"use strict";
				function _toConsumableArray(arr) {
					if (Array.isArray(arr)) {
						for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) arr2[i] = arr[i];
				...
				module$35.exports = FDLayout;
			}),
			(function(module$36, exports$33, __webpack_require__) {
				"use strict";
				var LEdge = __webpack_require__(1);
				var FDLayoutConstants = __webpack_require__(7);
				...
				module$36.exports = FDLayoutEdge;
			}),
			(function(module$37, exports$34, __webpack_require__) {
				"use strict";
				var LNode = __webpack_require__(3);
				...
				module$37.exports = FDLayoutNode;
			}),
			(function(module$38, exports$35, __webpack_require__) {
				"use strict";
				...
				module$38.exports = DimensionD;
			}),
			(function(module$39, exports$36, __webpack_require__) {
				"use strict";
			...
			(function(module$42, exports$39, __webpack_require__) {
				"use strict";
				var _createClass = function() {
					function defineProperties(target, props) {
						for (var i = 0; i < props.length; i++) {
...
var require_cose_base = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			function __webpack_require__(moduleId) {
				if (installedModules[moduleId]) return installedModules[moduleId].exports;
				var module$5 = installedModules[moduleId] = {
					i: moduleId,
					l: false,
					exports: {}
				};
				modules[moduleId].call(module$5.exports, module$5, module$5.exports, __webpack_require__);
				module$5.l = true;
			...
			__webpack_require__.d = function(exports$4, name, getter) {
				if (!__webpack_require__.o(exports$4, name)) Object.defineProperty(exports$4, name, {
					configurable: false,
					enumerable: true,
					get: getter
				});
			};
			__webpack_require__.n = function(module$6) {
				var getter = module$6 && module$6.__esModule ? function getDefault() {
					return module$6["default"];
				} : function getModuleExports() {
					return module$6;
				};
				__webpack_require__.d(getter, "a", getter);
			...
			(function(module$7, exports$5) {
				module$7.exports = __WEBPACK_EXTERNAL_MODULE_0__;
			}),
			(function(module$8, exports$6, __webpack_require__) {
				...
				module$8.exports = CoSEConstants;
			}),
			(function(module$9, exports$7, __webpack_require__) {
				"use strict";
				...
				module$9.exports = CoSEEdge;
			}),
			(function(module$10, exports$8, __webpack_require__) {
				"use strict";
				...
				module$10.exports = CoSEGraph;
			}),
			(function(module$11, exports$9, __webpack_require__) {
				"use strict";
				...
				module$11.exports = CoSEGraphManager;
			}),
			(function(module$12, exports$10, __webpack_require__) {
				"use strict";
...
var import_cytoscape_cose_bilkent = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function webpackUniversalModuleDefinition(root, factory) {
	...
	nodes.forEach((node) => {
		...
		Object.keys(node).forEach((key) => {
			if (![
				...
				"x",
				"y"
			].includes(key)) nodeData[key] = node[key];
		});
		cy.add({
			group: "nodes",
			data: nodeData,
	...
	edges.forEach((edge) => {
		...
		Object.keys(edge).forEach((key) => {
			if (![
				...
				"start",
				"end"
			].includes(key)) edgeData[key] = edge[key];
		});
		cy.add({
			group: "edges",
			data: edgeData
...
function extractPositionedNodes(cy) {
	return cy.nodes().map((node) => {
		...
		Object.keys(data).forEach((key) => {
			if (key !== "id") positionedNode[key] = data[key];
		});
	...
	return cy.edges().map((edge) => {
		...
		Object.keys(data).forEach((key) => {
			if (![
				...
				"source",
				"target"
			].includes(key)) positionedEdge[key] = data[key];
		});
...
function validateLayoutData(data) {
	if (!data) throw new Error("Layout data is required");
	if (!data.config) throw new Error("Configuration is required in layout data");
	if (!data.rootNode) throw new Error("Root node is required");
	if (!data.nodes || !Array.isArray(data.nodes)) throw new Error("No nodes found in layout data");
	if (!Array.isArray(data.edges)) throw new Error("Edges array is required in layout data");
	return true;
}
__name(validateLayoutData, "validateLayoutData");
var render2 = /* @__PURE__ */ __name(async (data4Layout, svg, { insertCluster, insertEdge, insertEdgeLabel, insertMarkers, insertNode, log: log2, positionEdgeLabel }, { algorithm: _algorithm }) => {
	const nodeDb = {};
	const clusterDb = {};
	...
	const layoutResult = await executeCoseBilkentLayout({
		...data4Layout,
	...
	await Promise.all(data4Layout.edges.map(async (edge) => {
		...
		if (startNode && endNode) {
			...
			if (positionedEdge) {
				...
				positionEdgeLabel(edgeWithPath, insertEdge(edgePaths, edgeWithPath, clusterDb, data4Layout.type, startNode, endNode, data4Layout.diagramId));
			} else {
				const edgeWithPath = {
					...edge,
					points: [{
