...
import { b as getConfig, s as common_default } from "./chunk-WYO6CB5R-J6ZhahPa.js";
import { d as interpolateToCurve } from "./chunk-ICXQ74PX-DIjkgJ-o.js";
import { a as insertNode, i as insertCluster, s as labelHelper } from "./chunk-ZGVPDNZ5-NwURWyhR.js";
import { a as markers_default, i as insertEdgeLabel, o as positionEdgeLabel, r as insertEdge } from "./chunk-52WLFC77-pQEewRxx.js";
...
(/* @__PURE__ */ __name(() => {
	registerLayoutLoaders([
		{
			name: "dagre",
			loader: /* @__PURE__ */ __name(async () => await import("./dagre-VKFMJZFB-DkPS2OiU.js"), "loader")
		},
		{
			name: "swimlane",
			loader: /* @__PURE__ */ __name(async () => await import("./swimlanes-5IMT3BWC-BDulmf94.js"), "loader")
		},
		...[{
			name: "cose-bilkent",
			loader: /* @__PURE__ */ __name(async () => await import("./cose-bilkent-JH36ORCC-0piymUKf.js"), "loader")
		}]
	]);
