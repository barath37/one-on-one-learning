...
import { H as setAccDescription, K as setDiagramTitle, U as setAccTitle, a as clear, c as configureSvgSize, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle } from "./chunk-WYO6CB5R-J6ZhahPa.js";
import { t as arc_default } from "./arc-DZNVyJUO.js";
import { t as getIconStyles } from "./chunk-5VM5RSS4-D50WUAUX.js";
import { a as drawRect, n as drawBackgroundRect, o as drawText, s as getNoteRect } from "./chunk-32BRIVSS-DMIuRkfi.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/journeyDiagram-5HDEW3XC.mjs
var parser = (function() {
...
var svgDraw_default = {
	...
	initGraphics: /* @__PURE__ */ __name(function(graphics, id) {
		taskCount = -1;
...
function drawActorLegend(diagram2) {
	...
	Object.keys(actors).forEach((person) => {
		...
		measureText.remove();
		let lines = [];
		if (fullTextWidth <= maxLabelWidth) lines = [person];
		else {
		...
		lines.forEach((line, index) => {
			...
			const lineWidth = svgDraw_default.drawText(diagram2, labelData).node().getBoundingClientRect().width;
			if (lineWidth > maxWidth && lineWidth > conf2.leftMargin - lineWidth) maxWidth = lineWidth;
		});
...
var draw = /* @__PURE__ */ __name(function(text, id, version, diagObj) {
	...
	if (title) diagram2.append("text").text(title).attr("x", leftMargin).attr("font-size", titleFontSize).attr("font-weight", "bold").attr("y", 25).attr("fill", titleColor).attr("font-family", titleFontFamily);
