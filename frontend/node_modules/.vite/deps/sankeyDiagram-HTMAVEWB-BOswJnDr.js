...
import { H as setAccDescription, J as setupGraphViewbox, K as setDiagramTitle, U as setAccTitle, a as clear, d as defaultConfig2, s as common_default, v as getAccDescription, w as getDiagramTitle, x as getConfig2, y as getAccTitle } from "./chunk-WYO6CB5R-J6ZhahPa.js";
...
//#endregion
//#region node_modules/mermaid/dist/chunks/mermaid.core/sankeyDiagram-HTMAVEWB.mjs
var parser = (function() {
...
var sankeyRenderer_default = { draw: /* @__PURE__ */ __name(function(text, id, _version, diagObj) {
	...
	Sankey().nodeId((d) => d.id).nodeWidth(nodeWidth).nodePadding(nodePadding + (showValues ? 15 : 0)).nodeAlign(nodeAlign).extent([[0, 0], [width, height]])(graph);
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
	...
	const getLabelPosition = /* @__PURE__ */ __name((d) => {
		if (labelStyle === "outlined") {
			if ((d.layer ?? 0) < centralNodeLayer) return {
				x: d.x0 - 6,
				anchor: "end"
			};
			return {
