...
import { O as getUrl, c as configureSvgSize, s as common_default, x as getConfig2 } from "./chunk-WYO6CB5R-J6ZhahPa.js";
import { et as basis_default, g as utils_default } from "./chunk-ICXQ74PX-DIjkgJ-o.js";
...
import "./chunk-FWX5IMBZ-BpptlmFU.js";
import { t as Graph } from "./graphlib-BuWQfb5t.js";
import { t as layout } from "./dagre-CZs8icuj.js";
import "./chunk-32BRIVSS-DMIuRkfi.js";
import "./chunk-XXDRQBXY-D_yO3p4L.js";
import "./chunk-VR4S4FIN-CR_s6iKG.js";
import { i as styles_default, n as stateDiagram_default, t as StateDB } from "./chunk-EX3LRPZG-Y30Y00Tl.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/stateDiagram-2N3HPSRC.mjs
...
var drawDescrState = /* @__PURE__ */ __name((g, stateDef) => {
	const addTspan = /* @__PURE__ */ __name(function(textEl, txt, isFirst2) {
		...
		if (!isFirst2) tSpan.attr("dy", getConfig2().state.textHeight);
	}, "addTspan");
	const titleBox = g.append("text").attr("x", 2 * getConfig2().state.padding).attr("y", getConfig2().state.textHeight + 1.3 * getConfig2().state.padding).attr("font-size", getConfig2().state.fontSize).attr("class", "state-title").text(stateDef.descriptions[0]).node().getBBox();
	const titleHeight = titleBox.height;
	const description = g.append("text").attr("x", getConfig2().state.padding).attr("y", titleHeight + getConfig2().state.padding * .4 + getConfig2().state.dividerMargin + getConfig2().state.textHeight).attr("class", "state-description");
	let isFirst = true;
	let isSecond = true;
...
var drawEdge = /* @__PURE__ */ __name(function(elem, path, relation) {
	...
	let url = "";
	if (getConfig2().state.arrowMarkerAbsolute) url = getUrl(true);
...
var draw = /* @__PURE__ */ __name(function(text, id, _version, diagObj) {
	...
	renderDoc(diagObj.db.getRootDoc(), diagram2.append("g").attr("id", id + "-root"), void 0, false, root, doc, diagObj);
...
var renderDoc = /* @__PURE__ */ __name((doc, diagram2, parentId, altBkg, root, domDocument, diagObj) => {
	...
	graph.nodes().forEach(function(v) {
		...
		} else log.debug("No Node " + v + ": " + JSON.stringify(graph.node(v)));
	});
