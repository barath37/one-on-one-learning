import { $ as arrayMap, A as baseKeys, B as baseRest, C as baseFlatten, D as castPath, E as toKey, F as baseUnary, H as eq, I as isBuffer, J as constant, K as setToString, L as isArguments, N as isTypedArray, O as toString, Q as isArray, S as Stack, T as baseGet, U as isIndex, V as overRest, W as baseFindIndex, X as identity, Y as isFunction, Z as isObject, _ as _getTag_default, a as filter, c as isArrayLikeObject, d as baseFor, et as isSymbol, f as baseIteratee, h as hasPath, i as values, it as root, k as keys, m as hasIn, n as reduce, nt as baseGetTag, o as forEach, p as baseProperty, r as isUndefined, s as castFunction, t as Graph, tt as isObjectLike, u as baseForOwn, z as isArrayLike } from "./graphlib-BuWQfb5t.js";
import { a as cloneTypedArray, c as keysIn, d as baseAssignValue, f as copyArray, i as initCloneObject, l as copyObject, n as baseMap, o as cloneBuffer, r as baseClone, s as getPrototype, t as map, u as assignValue } from "./map-BfMypv0p.js";
...
function greedyFAS(g, weightFn) {
	...
	return flatten(map(results, function(e) {
...
function initOrder(g) {
	...
	var maxRank = max(map(simpleNodes, function(v) {
		return g.node(v).rank;
	}));
