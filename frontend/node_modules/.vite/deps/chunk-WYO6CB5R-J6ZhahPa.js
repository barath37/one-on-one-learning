import { n as __name, t as __export } from "./chunk-Y2CYZVJY-CrOJDJJy.js";
import { B as setLogLevel, z as log } from "./src-FJkK6OsU.js";
...
//#endregion
//#region node_modules/mermaid/dist/chunks/mermaid.core/chunk-WYO6CB5R.mjs
...
var mkBorder = /* @__PURE__ */ __name((col, darkMode) => darkMode ? adjust(col, {
	s: -40,
	l: 10
}) : adjust(col, {
	s: -40,
...
var Theme = class {
	...
	updateColors() {
		...
		this.tertiaryColor = this.tertiaryColor || adjust(this.primaryColor, {
			h: 180,
			l: 5
		});
		...
		this.cScale8 = this.cScale8 || adjust(this.primaryColor, {
			h: 210,
			l: 150
		});
		...
		if (this.darkMode) for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScale" + i] = darken(this["cScale" + i], 75);
		else for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScale" + i] = darken(this["cScale" + i], 25);
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScaleInv" + i] = this["cScaleInv" + i] || invert(this["cScale" + i]);
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) if (this.darkMode) this["cScalePeer" + i] = this["cScalePeer" + i] || lighten(this["cScale" + i], 10);
		else this["cScalePeer" + i] = this["cScalePeer" + i] || darken(this["cScale" + i], 10);
		this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScaleLabel" + i] = this["cScaleLabel" + i] || this.scaleLabelColor;
		const multiplier = this.darkMode ? -4 : -1;
		for (let i = 0; i < 5; i++) {
			this["surface" + i] = this["surface" + i] || adjust(this.mainBkg, {
				h: 180,
				s: -15,
				l: multiplier * (5 + i * 3)
			});
			this["surfacePeer" + i] = this["surfacePeer" + i] || adjust(this.mainBkg, {
				h: 180,
				s: -15,
				l: multiplier * (8 + i * 3)
			});
		...
		this.pie7 = this.pie7 || adjust(this.primaryColor, {
			h: 60,
			l: -10
		});
		this.pie8 = this.pie8 || adjust(this.primaryColor, {
			h: -60,
			l: -10
		});
		this.pie9 = this.pie9 || adjust(this.primaryColor, {
			h: 120,
			l: 0
		});
		this.pie10 = this.pie10 || adjust(this.primaryColor, {
			h: 60,
			l: -20
		});
		this.pie11 = this.pie11 || adjust(this.primaryColor, {
			h: -60,
			l: -20
		});
		this.pie12 = this.pie12 || adjust(this.primaryColor, {
			h: 120,
			l: -10
		});
		...
		this.venn4 = this.venn4 ?? adjust(this.primaryColor, {
			h: 60,
			l: -30
		});
		this.venn5 = this.venn5 ?? adjust(this.primaryColor, {
			h: -60,
			l: -30
		});
		this.venn6 = this.venn6 ?? adjust(this.secondaryColor, {
			h: 60,
			l: -30
		});
		this.venn7 = this.venn7 ?? adjust(this.primaryColor, {
			h: 120,
			l: -30
		});
		this.venn8 = this.venn8 ?? adjust(this.secondaryColor, {
			h: 120,
			l: -30
		});
		...
		this.quadrant2Fill = this.quadrant2Fill || adjust(this.primaryColor, {
			r: 5,
			g: 5,
			b: 5
		});
		this.quadrant3Fill = this.quadrant3Fill || adjust(this.primaryColor, {
			r: 10,
			g: 10,
			b: 10
		});
		this.quadrant4Fill = this.quadrant4Fill || adjust(this.primaryColor, {
			r: 15,
			g: 15,
			b: 15
		});
		this.quadrant1TextFill = this.quadrant1TextFill || this.primaryTextColor;
		this.quadrant2TextFill = this.quadrant2TextFill || adjust(this.primaryTextColor, {
			r: -5,
			g: -5,
			b: -5
		});
		this.quadrant3TextFill = this.quadrant3TextFill || adjust(this.primaryTextColor, {
			r: -10,
			g: -10,
			b: -10
		});
		this.quadrant4TextFill = this.quadrant4TextFill || adjust(this.primaryTextColor, {
			r: -15,
			g: -15,
			b: -15
		});
...
var Theme2 = class {
	...
	constructor() {
		...
		this.border1 = "#ccc";
		this.border2 = rgba(255, 255, 255, .25);
	...
	updateColors() {
		...
		this.cScale11 = this.cScale11 || adjust(this.primaryColor, { h: 330 });
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScaleInv" + i] = this["cScaleInv" + i] || invert(this["cScale" + i]);
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScalePeer" + i] = this["cScalePeer" + i] || lighten(this["cScale" + i], 10);
		for (let i = 0; i < 5; i++) {
			this["surface" + i] = this["surface" + i] || adjust(this.mainBkg, {
				h: 30,
				s: -30,
		...
		this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black";
		this.pieOpacity = this.pieOpacity || "0.7";
		for (let i = 0; i < 8; i++) this["venn" + (i + 1)] = this["venn" + (i + 1)] ?? lighten(this["cScale" + i], 30);
		this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor;
		this.vennSetTextColor = this.vennSetTextColor ?? this.textColor;
		this.cynefin = {
			domainFontSize: this.cynefin?.domainFontSize || 16,
		...
		this.emSwimlaneBackgroundStroke = this.emSwimlaneBackgroundStroke || lighten(this.background, 12);
		this.emArrowhead = this.emArrowhead || this.lineColor;
		this.emRelationStroke = this.emRelationStroke || this.lineColor;
...
var Theme3 = class {
	...
	constructor() {
		...
		this.sectionBkgColor = rgba(102, 102, 255, .49);
	...
	updateColors() {
		...
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScaleInv" + i] = this["cScaleInv" + i] || adjust(this["cScale" + i], { h: 180 });
		for (let i = 0; i < 5; i++) {
			this["surface" + i] = this["surface" + i] || adjust(this.mainBkg, {
				h: 30,
				l: -(5 + i * 5)
...
var Theme5 = class {
	...
	updateColors() {
		...
		this.pieOuterStrokeColor = this.pieOuterStrokeColor || "black";
		this.pieOpacity = this.pieOpacity || "0.7";
		for (let i = 0; i < 8; i++) this["venn" + (i + 1)] = this["venn" + (i + 1)] ?? this["cScale" + i];
		this.vennTitleTextColor = this.vennTitleTextColor ?? this.titleColor;
		this.vennSetTextColor = this.vennSetTextColor ?? this.textColor;
		this.cynefin = {
			domainFontSize: this.cynefin?.domainFontSize || 16,
...
var Theme6 = class {
	...
	updateColors() {
		...
		const tertiaryColor = adjust(primaryColor, {
			h: 180,
			l: 5
		});
		...
		this.cScale8 = this.cScale8 || adjust(primaryColor, {
			h: 210,
			l: 150
		});
		...
		this.pie7 = this.pie7 || adjust(primaryColor, {
			h: 60,
			l: -10
		});
		this.pie8 = this.pie8 || adjust(primaryColor, {
			h: -60,
			l: -10
		});
		this.pie9 = this.pie9 || adjust(primaryColor, {
			h: 120,
			l: 0
		});
		this.pie10 = this.pie10 || adjust(primaryColor, {
			h: 60,
			l: -20
		});
		this.pie11 = this.pie11 || adjust(primaryColor, {
			h: -60,
			l: -20
		});
		this.pie12 = this.pie12 || adjust(primaryColor, {
			h: 120,
			l: -10
		});
		this.pieTitleTextSize = this.pieTitleTextSize || "25px";
		...
		this.quadrant2Fill = this.quadrant2Fill || adjust(primaryColor, {
			r: 5,
			g: 5,
			b: 5
		});
		this.quadrant3Fill = this.quadrant3Fill || adjust(primaryColor, {
			r: 10,
			g: 10,
			b: 10
		});
		this.quadrant4Fill = this.quadrant4Fill || adjust(primaryColor, {
			r: 15,
			g: 15,
			b: 15
		});
...
var Theme8 = class {
	...
	updateColors() {
		...
		this.transitionColor = this.transitionColor || this.lineColor;
		this.specialStateColor = this.lineColor;
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScale" + i] = this.mainBkg;
		if (this.darkMode) for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScale" + i] = darken(this["cScale" + i], 75);
		else for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScale" + i] = darken(this["cScale" + i], 25);
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScaleInv" + i] = this["cScaleInv" + i] || invert(this["cScale" + i]);
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) if (this.darkMode) this["cScalePeer" + i] = this["cScalePeer" + i] || lighten(this["cScale" + i], 10);
...
var Theme11 = class {
	...
	updateColors() {
		...
		this.scaleLabelColor = this.scaleLabelColor || this.labelTextColor;
		for (let i = 0; i < this.THEME_COLOR_LIMIT; i++) this["cScaleLabel" + i] = darken(this["cScale" + i], 75);
		const multiplier = this.darkMode ? -4 : -1;
		for (let i = 0; i < 5; i++) {
			this["surface" + i] = this["surface" + i] || adjust(this.mainBkg, {
				h: 180,
...
var themes_default = {
	...
	"redux-dark-color": { getThemeVariables: /* @__PURE__ */ __name((userOverrides) => {
...
var sanitizeDirective = /* @__PURE__ */ __name((args) => {
	...
	for (const key of Object.keys(args)) {
		...
		if (typeof args[key] === "object") {
			...
			if (valuePattern) sanitizeDictionaryConfig(args[key], valuePattern);
			else {
...
var updateCurrentConfig = /* @__PURE__ */ __name((siteCfg, _directives) => {
	...
	if (sumOfDirectives.theme && sumOfDirectives.theme in themes_default) {
		const themeVariables = assignWithDepth_default(assignWithDepth_default({}, configFromInitialize).themeVariables || {}, sumOfDirectives.themeVariables);
...
var getUserDefinedConfig = /* @__PURE__ */ __name(() => {
	let userConfig = {};
	if (configFromInitialize) userConfig = assignWithDepth_default(userConfig, configFromInitialize);
	for (const d of directives) userConfig = assignWithDepth_default(userConfig, d);
	return userConfig;
}, "getUserDefinedConfig");
var getEffectiveHtmlLabels = /* @__PURE__ */ __name((config2) => {
	if (config2.flowchart?.htmlLabels != void 0) issueWarning("FLOWCHART_HTML_LABELS_DEPRECATED");
...
var detectType = /* @__PURE__ */ __name(function(text, config2) {
	...
	for (const [key, { detector }] of Object.entries(detectors)) if (detector(text, config2)) return key;
...
var sanitizeMore = /* @__PURE__ */ __name((text, config2) => {
	if (getEffectiveHtmlLabels(config2)) {
		...
		if (level === "antiscript" || level === "strict" || level === "sandbox") text = removeScript(text);
		else if (level !== "loose") {
...
var renderKatexUnsanitized = /* @__PURE__ */ __name(async (text, config2) => {
	...
	{
		const { default: katex } = await import("./katex-B8uqE0wG.js");
...
var getStyles = /* @__PURE__ */ __name((type, userStyles, options, svgId) => {
	let diagramStyles = "";
	if (type in themes && themes[type]) diagramStyles = themes[type]({
		...options,
		svgId
	});
	else log.warn(`No theme found for ${type}`);
	return ` & {
...
var addStylesForDiagram = /* @__PURE__ */ __name((type, diagramTheme) => {
	if (diagramTheme !== void 0) themes[type] = diagramTheme;
}, "addStylesForDiagram");
...
//#endregion
export { purify as $, hasKatex as A, sanitizeText3 as B, getDiagramLoader as C, getThemeVariables3 as D, getSiteConfig as E, renderKatexSanitized as F, setConfig2 as G, setAccDescription as H, reset as I, setupGraphViewbox as J, setDiagramTitle as K, sanitizeCss as L, parseGenericTypes as M, registerDiagram as N, getUrl as O, registerLazyLoadedDiagrams as P, updateSiteConfig as Q, sanitizeDirective as R, getDiagram as S, getEffectiveHtmlLabels as T, setAccTitle as U, saveConfigFromInitialize as V, setConfig as W, styles_default as X, setupGraphViewbox2 as Y, themes_default as Z, frontMatterRegex as _, clear as a, Color as at, getConfig as b, configureSvgSize as c, defaultConfig2 as d, darken as et, defaultConfig_default as f, evaluate as g, directiveRegex as h, calculateMathMLDimensions as i, rgba as it, lineBreakRegex as j, getUserDefinedConfig as k, cssStyleSheetToString as l, detectors as m, addDirective as n, adjustChannel as nt, commonDb_exports as o, Utils as ot, detectType as p, setSiteConfig as q, assignWithDepth_default as r, isDark as rt, common_default as s, UnknownDiagramError as t, lighten as tt, defaultConfig as u, getAccDescription as v, getDiagramTitle as w, getConfig2 as x, getAccTitle as y, sanitizeText as z };
