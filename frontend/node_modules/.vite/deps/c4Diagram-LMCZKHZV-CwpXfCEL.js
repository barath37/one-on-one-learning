...
import { H as setAccDescription, U as setAccTitle, c as configureSvgSize, r as assignWithDepth_default, s as common_default, v as getAccDescription, x as getConfig2, y as getAccTitle, z as sanitizeText } from "./chunk-WYO6CB5R-J6ZhahPa.js";
import { t as require_dist } from "./dist-CY3y74om.js";
import { _ as wrapLabel, n as calculateTextHeight, r as calculateTextWidth } from "./chunk-ICXQ74PX-DIjkgJ-o.js";
import { a as drawRect, s as getNoteRect } from "./chunk-32BRIVSS-DMIuRkfi.js";
//#region node_modules/mermaid/dist/chunks/mermaid.core/c4Diagram-LMCZKHZV.mjs
...
var setC4Type = /* @__PURE__ */ __name(function(c4TypeParam) {
	c4Type = sanitizeText(c4TypeParam, getConfig2());
}, "setC4Type");
...
var c4Db_default = {
	...
	setTitle: /* @__PURE__ */ __name(function(txt) {
		title = sanitizeText(txt, getConfig2());
	}, "setTitle"),
	setC4Type
};
...
var drawRels = /* @__PURE__ */ __name((elem, rels2, conf2, diagramId) => {
	...
	for (let rel of rels2) {
		...
		if (i === 0) {
			...
			if (rel.type !== "rel_b") line.attr("marker-end", "url(#" + diagramId + "-arrowhead)");
			if (rel.type === "birel" || rel.type === "rel_b") line.attr("marker-start", "url(#" + diagramId + "-arrowend)");
			i = -1;
		} else {
...
var insertArrowCrossHead = /* @__PURE__ */ __name(function(elem, id) {
	const marker = elem.append("defs").append("marker").attr("id", id + "-crosshead").attr("markerWidth", 15).attr("markerHeight", 8).attr("orient", "auto").attr("refX", 16).attr("refY", 4);
...
var c4Renderer_default = {
	...
	setConf,
	draw: /* @__PURE__ */ __name(function(_text, id, _version, diagObj) {
		conf = getConfig2().c4;
		...
		drawInsideBoundary(diagram2, "", screenBounds, diagObj.db.getBoundaries(""), diagObj);
...
var diagram = {
	...
	styles: /* @__PURE__ */ __name((options) => `.person {
